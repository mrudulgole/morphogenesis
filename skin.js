...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs+='background : rgba(199,199,199,0.498039);';
		...
		me.divSkin.appendChild(me._controller_bg);
		el=me._cardboard=document.createElement('div');
		els=me._cardboard__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'LTQuOTE0LTEwLjk3OS0xMC45NzkgIGMwLTYuMDYzLDQuOTE2LTEwLjk3OCwxMC45NzktMTAuOTc4YzYuMDYyLDAsMTAuOTc4LDQuOTE1LDEwLjk3OCwxMC45NzhDNzUuMzEyLDQ5LjY2OCw3MC4zOTYsNTQuNTgyLDY0LjMzNCw1NC41ODJ6Ij48L3BhdGg+PC9zdmc+';
		me._cardboard__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;cardboard;');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._cardboard.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._cardboard.onclick=function (e) {
			player.openUrl("vr.html#"+me.ggUserdata.source,"_self");
		}
		me._cardboard.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._cardboard);
